...
public class Route  implements java.io.Serializable {
    ...
    public Route(Agency agency, City city, String routeName, String routeContent, int routeDay, int routeScore, float routePrice, String routeImage, Date routeStartDay, Set routecomments) {
       this.agency = agency;
       this.city = city;
       this.routeName = routeName;
       this.routeContent = routeContent;
