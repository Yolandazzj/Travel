...
<div class="grzxbj">
    <div class="selfinfo center">
        <div class="lfnav fl">
            ...
            <div class="subddzx">
                <ul>
                    <li><a href="admin/orderAll" style="color:#ff6700;font-weight:bold;">所有订单</a></li>
                </ul>
            </div>
        ...
        <div class="rtcont fr">
            ...
            <c:forEach items="${myOrderList}" var="mo">
                <div class="ddxq" id="${mo.routeOrderId}">
                    ...
                    <div class="ztxx fr">
                        <ul>
                            ...
                            <li><button  type="button" value="交易成功" class="search-but" style="font-size: 16px;margin-left: 15px;margin-top: 10px;" onclick="javascript:deleteOrder(${mo.routeOrderId})">交易成功</button></li>
                            <div class="clear"></div>
                        </ul>
                    </div>
        ...
        <form id="paging" style="text-align:center;">
            <tr>
                <td colspan="8" align="center" >共${orderPage.totalRecords}条记录 共${orderPage.totalPages}页 当前第${orderPage.pageNo}页
                    ...
                    <a href="admin/orderAll?pageNo=${orderPage.topPageNo}"><input type="button" name="fristPage" value="首页" /></a>

                    <c:choose>
                        <c:when test="${orderPage.pageNo!=1}">

                            <a href="admin/orderAll?pageNo=${orderPage.previousPageNo}"><input type="button" name="previousPage" value="上一页" /></a>
                    ...
                    <c:choose>
                        <c:when test="${orderPage.pageNo!= orderPage.totalPages}">
                            <a href="admin/orderAll?pageNo=${orderPage.nextPageNo}"><input type="button" name="nextPage" value="下一页" /></a>
                        </c:when>
                        <c:otherwise>
                    ...
                    <a href="admin/orderAll?pageNo=${orderPage.bottomPageNo }"><input type="button" name="lastPage" value="尾页" /></a>
                </td>
            </tr>
        </form>
    </div>
