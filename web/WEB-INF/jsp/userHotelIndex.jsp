...
<div class="content-top" style="height: 400px;">
    ...
    <div class="sidebar" style="height: 400px;">
        ...
        <div class="sidebar-info">
            <ul class="side-li">
                <li class="s_1" style="height: 70px;line-height: 75px;"><h3>酒店美食<span class="fa fa-angle-right fa-loc"></span></h3></li>
    ...
    <div class="right-con">
        ...
        <div class="show-box" >
            ...
            <div class="content" >
                <ul class="imgBox">
                    <li><a href="#"><img src="resources/image/hotel1.jpg"></a></li>
                    <li><a href="#"><img src="resources/image/hotel2.jpg"></a></li>
                    <li><a href="#"><img src="resources/image/hotel3.jpg"></a></li>
    ...
    <div class="routemain center">
        <div class="routecontent">
            ...
            <div class="remen fl">
                ...
                <div class="miaoshu"><a href="">${hotel1.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel1.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            ...
            <div class="remen fl">
                ...
                <div class="tu"><a href="user/toHotelDetails?hotelId=${hotel2.hotelId}"><img src="/IMAGE/${hotel2.hotelImage}"></a></div>
                <div class="miaoshu"><a href="">${hotel2.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel2.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top3</span></div>
                <div class="tu"><a href="user/toHotelDetails?hotelId=${hotel3.hotelId}"><img src="/IMAGE/${hotel3.hotelImage}"></a></div>
                <div class="miaoshu"><a href="">${hotel3.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel3.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top4</span></div>
                <div class="tu"><a href="user/toHotelDetails?hotelId=${hotel4.hotelId}"><img src="/IMAGE/${hotel4.hotelImage}"></a></div>
                <div class="miaoshu"><a href="">${hotel4.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel4.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="clear"></div>
        ...
        <div class="routecontent">
            ...
            <div class="remen fl">
                ...
                <div class="tu"><a href="user/toHotelDetails?hotelId=${hotel5.hotelId}"><img src="/IMAGE/${hotel5.hotelImage}"></a></div>
                <div class="miaoshu"><a href="">${hotel5.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel5.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top6</span></div>
                <div class="tu"><a href="user/toHotelDetails?hotelId=${hotel6.hotelId}"><img src="/IMAGE/${hotel6.hotelImage}"></a></div>
                <div class="miaoshu"><a href="">${hotel6.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel6.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top7</span></div>
                <div class="tu"><a href="user/toHotelDetails?hotelId=${hotel7.hotelId}"><img src="/IMAGE/${hotel7.hotelImage}"></a></div>
                <div class="miaoshu"><a href="">${hotel7.hotelName}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${hotel7.hotelScore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remenlast fr">
                <div class="liulangengduo"><a href="user/hotelAll"><img src="./resources/image/liulan.png" alt=""></a></div>
            </div>
            <div class="clear"></div>
        </div>
    </div>
