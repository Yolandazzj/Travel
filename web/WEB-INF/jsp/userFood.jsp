...
<div class="content-top" style="height: 400px;">
    ...
    <div class="sidebar" style="height: 400px;">
        ...
        <div class="sidebar-info">
            <ul class="side-li">
                <li class="s_1" style="height: 70px;line-height: 75px;"><h3>美食类别<span class="fa fa-angle-right fa-loc"></span></h3></li>
...
<%--                                <a href="#">鸣沙山</a><span>|</span>--%>
    ...
    <div class="right-con">
        ...
        <div class="show-box" >
            ...
            <div class="content" >
                <ul class="imgBox">
                    <li><a href="#"><img src="resources/image/food1.jpg"></a></li>
                    <li><a href="#"><img src="resources/image/food2.jpg"></a></li>
                    <li><a href="#"><img src="resources/image/food3.jpg"></a></li>
...
<!--美食-->
<div class="gentuan w">
    <div class="biaoti center">美食</div>
    <div class="routemain center">
        <div class="routecontent">
            <div class="remen fl" style="height: 550px;"><a href="">大受欢迎的美食</a></div>
            <div class="remen fl">
                <div class="luxian"><span>top1</span></div>
                <div class="tu"><a href="user/foodDetails?fid=${food1.fid}&fname=${food1.fname}"><img src="/IMAGE/${food1.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food1.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food1.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            ...
            <div class="remen fl">
                ...
                <div class="tu"><a href="user/foodDetails?fid=${food2.fid}&fname=${food2.fname}"><img src="/IMAGE/${food2.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food2.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food2.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top3</span></div>
                <div class="tu"><a href="user/foodDetails?fid=${food3.fid}&fname=${food3.fname}"><img src="/IMAGE/${food3.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food3.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food3.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top4</span></div>
                <div class="tu"><a href="user/foodDetails?fid=${food4.fid}&fname=${food4.fname}"><img src="/IMAGE/${food4.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food4.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food4.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="clear"></div>
        ...
        <div class="routecontent">
            ...
            <div class="remen fl">
                ...
                <div class="tu"><a href="user/foodDetails?fid=${food5.fid}&fname=${food5.fname}"><img src="/IMAGE/${food5.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food5.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food5.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top6</span></div>
                <div class="tu"><a href="user/foodDetails?fid=${food6.fid}&fname=${food6.fname}"><img src="/IMAGE/${food6.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food6.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food6.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remen fl">
                <div class="luxian"><span>top7</span></div>
                <div class="tu"><a href="user/foodDetails?fid=${food7.fid}&fname=${food7.fname}"><img src="/IMAGE/${food7.fimage}"></a></div>
                <div class="miaoshu"><a href="">${food7.fname}</a></div>
                <div class="piao">
                    <a href="">
                        <span>${food7.fscore}人点赞</span>
                    </a>
                </div>
            </div>
            <div class="remenlast fr">
                <div class="liulangengduo"><a href="user/foodAll"><img src="./resources/image/liulan.png" alt=""></a></div>
            </div>
            <div class="clear"></div>
        </div>
    </div>
